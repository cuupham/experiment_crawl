...
for i in range(5):
    ...
    # Get Elements
    nameCompany_e = browser.find_elements(By.XPATH,
                                          "/html/body/div[1]/div[2]/div/div[2]/main/section/div/div[2]/div/h3/a")
    masothue_e = browser.find_elements(By.XPATH,
                                       "/html/body/div[1]/div[2]/div/div[2]/main/section/div/div[2]/div/div/a")
    nguoidaidien_e = browser.find_elements(By.XPATH,
                                           "/html/body/div[1]/div[2]/div/div[2]/main/section/div/div[2]/div/div/em/a")
    diachi_e = browser.find_elements(By.XPATH,
                                     "/html/body/div[1]/div[2]/div/div[2]/main/section/div/div[2]/div/address")
...
df.to_excel("output/msthue_list.xlsx", index=False)
